...
const EditScreen = ({ route, navigation }) => {
  ...
  const toolsFilter = [
    { name: 'Thread',  endpoint_filter_type: 'thread' },
    { name: 'ASCII Art',  endpoint_filter_type: 'ascii_art' },
    { name: 'Comic',  endpoint_filter_type: 'comic' },
    { name: 'Sketch',  endpoint_filter_type: 'sketch' },
    { name: 'Color Sketch',  endpoint_filter_type: 'color_sketch' },
    { name: 'Water Color',  endpoint_filter_type: 'water_color' },
    { name: 'Edge Sketch',  endpoint_filter_type: 'canny' },
    { name: 'Heat Map',  endpoint_filter_type: 'heat' },
    { name: 'Neon',  endpoint_filter_type: 'neon' },
    { name: 'Haunted',  endpoint_filter_type: 'haunted' },
    { name: 'Oil Paint',  endpoint_filter_type: 'oil_paint' },
    { name: 'Cartoon',  endpoint_filter_type: 'cartoon' },
    { name: 'X-Ray',  endpoint_filter_type: 'xray' },
    { name: 'Invert Colors',  endpoint_filter_type: 'invert' },
    { name: 'Frost',  endpoint_filter_type: 'frost' },
    { name: 'Dot',  endpoint_filter_type: 'dot' },
    { name: 'Retro',  endpoint_filter_type: 'retro' },
    { name: 'Grayscale',  endpoint_filter_type: 'grayscale' },
    { name: 'Pixelate',  endpoint_filter_type: 'pixelate' },
  ].map(tool => ({
    ...tool,
  ...
  const toolsEnhance = [
    ...
    { name: 'Bg Remove', icon: 'vector-line', lib: MCIcon, endpoint_filter_type: 'bgrem' },
